import { from, Observable, fromEvent, range, timer, interval } from 'rxjs';
import { map, scan } from 'rxjs/operators';

//======================================================================================================================
// of - stream from different things
...
//======================================================================================================================
// from - stream from array

// const array$ = from([1, 2, 3, 4]).pipe(scan((acc, v) => acc.concat(v), []));
//
// array$.subscribe((val) => {
// 	console.log(val);
// });
...
//======================================================================================================================
// fromEvent - stream from events

// fromEvent(document.querySelector('canvas'), 'mousemove')
// 	.pipe(map((e) => ({ x: e.offsetX, y: e.offsetY, ctx: e.target.getContext('2d') })))
// 	.subscribe((pos) => {
